...
​	本次对象管理实验，我们建立新的表结构，设置构造器，建立索引。实验过程涉及四张表的创建，表结构修改，构造器设置，和对应的创建索引。实验过程多，分步骤操作多，比较容易出错，好在有老师的讲解和文档的帮助，我们一步一步操作，虽然中间有出错，导致整个实验推翻重来，但是也是对实验越发的熟悉，最终还是顺利完成了实验。
